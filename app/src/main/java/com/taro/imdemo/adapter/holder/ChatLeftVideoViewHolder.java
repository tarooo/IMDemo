...
public class ChatLeftVideoViewHolder extends BaseViewHolder<MessageInfo> {
    private ImageView thumbImg;
    private ProgressBar progressBar;
    private RelativeLayout contentRl;
    public ChatLeftVideoViewHolder(ViewGroup parent) {
        super(parent, R.layout.item_video_message);
