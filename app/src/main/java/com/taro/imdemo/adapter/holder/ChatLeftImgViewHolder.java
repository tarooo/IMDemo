...
public class ChatLeftImgViewHolder extends BaseViewHolder<MessageInfo> {

    private ImageView contentImg;
    private ImageView headerImg;
    private ChatAdapter.OnItemClickListener onItemClickListener;
    public ChatLeftImgViewHolder(ViewGroup parent,ChatAdapter.OnItemClickListener onItemClickListener) {
        super(parent, R.layout.item_img_message);
